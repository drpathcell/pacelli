...
/// Main shell with bottom navigation bar (Home, Tasks, Calendar, Settings).
///
/// Wraps the four root tabs using GoRouter's ShellRoute. Applies a directional
/// slide transition that matches the tab position — sliding in from right for
/// higher-index tabs and from left for lower-index tabs. Only one page is
/// ever in the widget tree at a time, avoiding GlobalKey conflicts.
